                        ...
                        <div class="form-rating__container">
                            ...
                            <div class="form-rating__group">
                                ...
                                <div class="form-rating">
                                    ...
                                    <label class="form-rating__star" for="star5"><i class="fa-solid fa-star"></i></label>

                                    <input class="form-rating__input" id="star4" name="rating" type="radio" value="4">
                                    <label class="form-rating__star" for="star4"><i class="fa-solid fa-star"></i></label>

                                    <input class="form-rating__input" id="star3" name="rating" type="radio" value="3">
                                    <label class="form-rating__star" for="star3"><i class="fa-solid fa-star"></i></label>

                                    <input class="form-rating__input" id="star2" name="rating" type="radio" value="2">
                                    <label class="form-rating__star" for="star2"><i class="fa-solid fa-star"></i></label>

                                    <input class="form-rating__input" id="star1" name="rating" type="radio" value="1">
                                    <label class="form-rating__star" for="star1"><i class="fa-solid fa-star"></i></label>
                                </div>
                            </div>
                            ...
                            <div class="form-rating__comment">
                                <textarea class="form-rating__comment-test" name="comment" rows="10" placeholder="コメントを入力してください"></textarea>
                            </div>
                            <div class="error-message">
                                @error('comment')
                                {{ $message }}
